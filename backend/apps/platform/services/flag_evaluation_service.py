# yss_orbit\backend\apps\feature_flags\services\flag_evaluation_service.py
import logging
...
class FlagEvaluationService:
    ...
    def process(cls, data: Dict[str, Any], user_id: str = "system") -> bool:
        ...
        AuditService.record(
            action="UPDATE",
            resource="feature_flags.FlagEvaluation",
