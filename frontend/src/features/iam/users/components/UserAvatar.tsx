// yss_orbit\frontend\src\modules\user\components\UserAvatar.tsx
...
export const UserAvatar: React.FC<UserAvatarProps> = ({ id, className = '' }) => {
  ...
  if (isLoading) {
    return <div className="flex justify-center items-center p-8 animate-pulse text-gray-500">Loading UserAvatar...</div>;
  }

  return (
    <div className={`bg-white shadow-md rounded-lg p-6 hover:shadow-lg transition-shadow duration-300 ${className}`}>
      <h2 className="text-2xl font-semibold text-gray-800 mb-4 border-b pb-2">UserAvatar</h2>
