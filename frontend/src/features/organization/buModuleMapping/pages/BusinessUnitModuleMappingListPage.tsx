...
} from '@/features/organization/businessUnit/hooks/useBusinessUnits';
...
export default function BusinessUnitModuleMappingListPage() {
  ...
  const handleView   = useCallback((u: BusinessUnit) => navigate(`/platform/bu-module-mapping/${u.id}`), [navigate]);
  ...
  return (
    <>
      <div className="p-6 max-w-7xl mx-auto space-y-6 pb-16">
        <PageHeader title="BU-Module Mapping" subtitle="Assign and manage platform modules for business units." icon={Building2} />
        ...
        {isLoading ? (
          ...
          <EmptyState
            ...
            description="Adjust your filters to get started."
